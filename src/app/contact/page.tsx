  ...
  return (
    <div className="space-y-8">
      ...
      >
        ...
        {status === 'success' ? (
          <p className="col-span-full text-sm text-green-700">Message sent successfully!</p>
        ) : null}
        {status === 'error' ? (
          <p className="col-span-full text-sm text-red-700">Unable to send message. Please try again.</p>
        ) : null}
      </form>
    </div>
  );
